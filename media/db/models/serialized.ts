...
export type MediaFileDto = {
  ...
  videoProcessingTaskVideos?: VideoProcessingTaskDto[];
  videoProcessingTaskAudios?: VideoProcessingTaskDto[];
};
...
export type VideoProcessingTaskDto = {
  ...
  videoId: string | null;
  audioId: string | null;
  batch?: VideoProcessingBatchDto | null;
  video?: MediaFileDto | null;
  audio?: MediaFileDto | null;
};
